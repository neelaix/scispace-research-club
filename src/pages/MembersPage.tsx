...
function FounderCard({
  ...
  return (
    <motion.div
      ...
      className="card-surface group relative flex h-full flex-col items-center gap-4 p-7 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover"
    >
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="mt-1 whitespace-nowrap text-xs font-medium uppercase tracking-widest text-brand-dark/50">{note}</p>
        <a
